...
进度、战利品表、函数、结构、标签、断言、模型、材质等文件的调用格式均为`命名空间:文件夹/文件名`对应`命名空间/xxx/文件夹/文件名.后缀`文件，`xxx` 为 `advancements, loot_tables, functions, strutures, tags/blocks, tags/items, models, textures` 等。
